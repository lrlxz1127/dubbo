...
public class UrlUtils {
	...
	public static void main(String[] args) {
		String[] addresses = Constants.REGISTRY_SPLIT_PATTERN.split(
				"10.0.41.171:2181,10.0.41.218:2182,10.0.41.179:2183,10.0.41.231:2186,10.0.41.163:2188,10.0.41.246:2189,10.0.41.175:2190,10.0.41.224:2191,10.0.41.156:2192,10.0.41.212:2193,10.0.41.169:2194,10.0.41.157:2195");
	...
	/**
	 * Check if the given value matches the given pattern. The pattern supports
	 * wildcard "*".
	 *
